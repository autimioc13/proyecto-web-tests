...
export default function QuizIntro({ quiz, onStart }: QuizIntroProps) {
  return (
    <div className="bg-white/10 dark:bg-white/5 backdrop-blur-xl border border-white/20 rounded-xl shadow-lg p-8 sm:p-12 text-center max-w-2xl mx-auto">
      ...
      <button
        onClick={onStart}
        className="px-8 py-3 bg-white/20 dark:bg-white/10 text-gray-900 dark:text-white font-semibold text-lg rounded-lg hover:bg-white/30 dark:hover:bg-white/15 hover:shadow-lg transition-all w-full sm:w-auto border border-white/20 backdrop-blur-sm"
      >
        ¡Comenzar Ahora! 🚀
      </button>
